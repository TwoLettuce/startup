...
- [x] **Stores data in MongoDB** - Match, User, and Auth data stored in DB
- [x] **Stores credentials in MongoDB** - credentials stored in MongoDB and login and register work as expected
