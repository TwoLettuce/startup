    ...
    function knightButtons(){
        return (
            <div className="container">
                ...
                <button className="play_button" onClick={()=>props.onPressed(new move("Wide Sweep", "heal", 10, 0, 5))}>
    ...
    function wizardButtons(){
        return (
            <div className="container">
                ...
                <button className="play_button" onClick={()=>props.onPressed(new move("Mana Barrier", "dmg", 0, 0, 5))}>
                    <h4>Mana Barrier</h4>
                    Mana: 5&#13;
                    Block 85% of incoming physical damage
                </button>
                <button className="play_button" onClick={()=>props.onPressed(new move("Wide Sweep", "hybrid", 5, 100, -5))}>
                    <h4>Siphon Life</h4>
                    Accuracy: 100%  &#13;
